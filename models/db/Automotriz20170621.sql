...
INSERT INTO `novedad` (`id`,`vehiculo_id`,`problema`,`causa`,`solucion`,`proceso`,`elementos`,`observaciones`,`tecnico_asigna`,`supervisor_id`,`tecnico_repara`,`usuario_registra`,`tiempo_ejecucion`,`fecha_ingreso`,`fecha_atencion`,`atendido`,`kilometraje`,`tipo_falla_id`) VALUES 
 (1,1,'no enciende','Desconocida','otra pruebqqq','swdsd','zddad','',16,1,16,3,'3 horas','2017-06-11','2017-06-13',1,0,1),
 (2,1,'no encuiend luces','focos quemados','wdssd','sodjslkdjlsd osdjlsdmsdnmsd','sdsdsd.sdm','sfssd',16,1,16,3,'2 horas','2017-06-12','2017-06-15',1,0,40),
 (3,1,'wdsd','asdssasa','xcxcxc','asas','zsasa','sesdsd',14,1,14,3,'3 horas','2017-06-12','2017-06-14',1,600,7),
 (4,1,'','','otra prueba','sdssd','sdsd','',16,1,16,3,'3 horas','2017-06-13','2017-06-13',1,600,2),
 (5,1,'otro problem','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,NULL,'2017-06-13',NULL,0,750,0);
...
INSERT INTO `orden_plan` (`id`,`vehiculo_plan_id`,`fecha_emision`,`tecnico_asignado`,`fecha_atencion`,`tiempo_ejecucion`,`observacion`,`tecnico_atiende`,`atendido`) VALUES 
 (7,22,'2017-06-07',16,'2017-06-07','39','sl',16,1),
 (8,22,'2017-06-11',16,'2017-06-12','30 minutos','he cmabia de a',16,1),
 (9,23,'2017-06-11',16,'2017-06-11','5 horas','ninguna',2,1),
 (10,21,'2017-06-12',2,NULL,NULL,NULL,NULL,0),
 (11,23,'2017-06-12',2,NULL,NULL,NULL,NULL,0),
 (12,22,'2017-06-13',16,NULL,NULL,NULL,NULL,0);
...
INSERT INTO `plan_mantenimiento` (`id`,`tiempo_ejecucion`,`estado_maquina`,`herramientas`,`materiales`,`equipo`,`procedimiento`,`observaciones`,`tarea`,`tecnico_id`,`tipo_id`,`unidad_id`,`unidad_numero`,`alerta_numero`,`eliminado`) VALUES 
 ...
 (10,'6 HM',1,'<p>wlwe</p>\r\n','<p>ahii</p>\r\n','ahhhksksk','&lt;p&gt;jane&lt;/p&gt;','&lt;p&gt;ahiii&lt;/p&gt;','Tarea',2,3,0,3,2,1),
 (11,'ldsl',0,'<p>sdlsl</p>\r\n','<p>sdll</p>\r\n','','&lt;p&gt;sdlds&lt;/p&gt;','&lt;p&gt;dslsl&lt;/p&gt;','slds',2,3,0,6,3,1),
 (12,'aa',1,'<p>dd</p>\r\n','<p>dsd</p>\r\n','aa','&lt;p&gt;dssd&lt;/p&gt;','&lt;p&gt;dfdf&lt;/p&gt;','1111',2,4,0,6,5,0),
 (13,'dsldsl',1,'<p>dsk</p>\r\n','<p>sasak</p>\r\n','dslsdl','&lt;p&gt;dsk&lt;/p&gt;','&lt;p&gt;kdk&lt;/p&gt;','asksak dkkds 777',2,1,0,4,3,1),
 (14,'50',1,'<p>Ahi va</p>\r\n','<p>Ahi va</p>\r\n','ask','&lt;p&gt;Ahi va&lt;/p&gt;','&lt;p&gt;as&lt;/p&gt;','Mantenimiento Ejemplo',16,1,1,200,50,0),
 (15,'10',0,'<p>dl</p>\r\n','<p>asll</p>\r\n','sñ','&lt;p&gt;dsl&lt;/p&gt;','&lt;p&gt;dsl&lt;/p&gt;','prueba de mantenimiento',2,1,1,100,10,1);
...
INSERT INTO `registro` (`id`,`vehiculo_id`,`fecha_registro`,`fecha`,`numero_ingreso`,`usuario_registro`,`tipo`) VALUES 
 (32,8,'2017-06-07','2017-06-06',257,6,1),
 (33,8,'2017-06-07','2017-06-07',430,6,1),
 (34,1,'2017-06-11','2017-06-11',500,3,1),
 (35,1,'2017-06-12','2017-06-12',600,3,1),
 (36,1,'2017-06-13','2017-06-13',750,3,1);
/*!40000 ALTER TABLE `registro` ENABLE KEYS */;


--
-- Definition of table `tipo_falla`
--
...
INSERT INTO `tipo_falla` (`id`,`nombre`,`descripcion`,`eliminado`) VALUES 
 (1,'El vehículo no se enciende','El vehículo no se enciende',0),
 (2,'Nivel de refrigerante bajo','Nivel de refrigerante bajo',0),
 (3,'Nivel de líquido de frenos bajo','Nivel de líquido de frenos bajo',0),
 (4,'Nivel de líquido hidráulico bajo','Nivel de líquido hidráulico bajo',0),
 (5,'Batería descargada','Batería descargada',0),
 (6,'Presión del neumático inadecuado','Presión del neumático inadecuado',0),
 (7,'Fugas de aceite','Fugas de aceite',0),
 (8,'Fugas de combustible','Fugas de combustible',0),
 (9,'Fugas de refrigerante','Fugas de refrigerante',0),
 (10,'Halógenos quemados','Halógenos quemados',0),
 (11,'Ralentí inadecuado','Ralentí inadecuado',0),
 (12,'Temperatura del motor inadecuado','Temperatura del motor inadecuado',0),
 (13,'Ruidos extraños','Ruidos extraños',0),
 (14,'Bandas rotos','Bandas rotos',0),
 (15,'Paquetes de ballestas rotas','Paquetes de ballestas rotas',0),
 (16,'Amortiguadores deteriorados','Amortiguadores deteriorados',0),
 (17,'Gala la dirección al conducir','Gala la dirección al conducir',0),
 (18,'El vehículo enciende pero no tiene fuerza','El vehículo enciende pero no tiene fuerza',0),
 (19,'El vehículo enciende pero al acelerar se apaga','El vehículo enciende pero al acelerar se apaga',0),
 (20,'Luces de testigo se prenden en el tablero de instrumentos','Luces de testigo se prenden en el tablero de instrumentos',0),
 (21,'No entra la marcha','No entra la marcha',0),
 (22,'El vehículo  no acelera','El vehículo  no acelera',0),
 (23,'Se queda pegado el pedal del embrague','Se queda pegado el pedal del embrague',0),
 (24,'Elementos extraños incrustados en los neumáticos','Elementos extraños incrustados en los neumáticos',0),
 (25,'Terminales sucios o sueltos','Terminales sucios o sueltos',0),
 (26,'Mal funcionamiento de sistema de encendido','Mal funcionamiento de sistema de encendido',0),
 (27,'Baja compresión en los cilindros','Baja compresión en los cilindros',0),
 (28,'Defectos en el motor de arranque','Defectos en el motor de arranque',0),
 (29,'Succión de aire directa','Succión de aire directa',0),
 (30,'Detonación en los cilindros al exigir potencia al motor','Detonación en los cilindros al exigir potencia al motor',0),
 (31,'Bujía de mal estado o carbonizado','Bujía de mal estado o carbonizado',0),
 (32,'Mala sincronización','Mala sincronización',0),
 (33,'Junta de culata en mal estado','Junta de culata en mal estado',0),
 (34,'Carbón en la cámara de explosión','Carbón en la cámara de explosión',0),
 (35,'Válvulas de motor en mal estado y tolerancia','Válvulas de motor en mal estado y tolerancia',0),
 (36,'Filtros obstruidos','Filtros obstruidos',0),
 (37,'Bobina quemada','Bobina quemada',0),
 (38,'Defectos de modulo electrónico','Defectos de modulo electrónico',0),
 (39,'Conexiones eléctricas sueltas en el circuito de la bobina','Conexiones eléctricas sueltas en el circuito de la bobina',0),
 (40,'Interruptor de contacto defectuosos','Interruptor de contacto defectuosos',0),
 (41,'Anillos sincronizadores en mal estado','Anillos sincronizadores en mal estado',0),
 (42,'Kit de embrague defectuoso','Kit de embrague defectuoso',0),
 (43,'Palanca de cambios desconectada de su varillaje','Palanca de cambios desconectada de su varillaje',0),
 (44,'Engranes o ejes rotos de caja de cambios','Engranes o ejes rotos de caja de cambios',0),
 (45,'Rodamientos de ruedas dañadas','Rodamientos de ruedas dañadas',0),
 (46,'Engranajes de satélites en mal estado','Engranajes de satélites en mal estado',0),
 (47,'Retenes o sellos en mal estado','Retenes o sellos en mal estado',0),
 (48,'Desgaste general de conjunto de la dirección','Desgaste general de conjunto de la dirección',0),
 (49,'Roturas desgastadas','Roturas desgastadas',0),
 (50,'Pastillas o forros de friccione zapatas degastados','Pastillas o forros de friccione zapatas degastados',0),
 (51,'Fallas de servo freno','Fallas de servo freno',0),
 (52,'Pistones impulsores agarrotados','Pistones impulsores agarrotados',0),
 (53,'Disco y tambor de freno en mal estado','Disco y tambor de freno en mal estado',0),
 (54,'Cables o fusibles quemados','Cables o fusibles quemados',0),
 (55,'Inyectores obstruidos o desgastados','Inyectores obstruidos o desgastados',0),
 (56,'Turbo de los motores sobrealimentados','Turbo de los motores sobrealimentados',0),
 (57,'Otros','Otros',0);
...
INSERT INTO `tipo_usuario` (`id`,`nombre`,`descripcion`) VALUES 
 (1,'Administrador','Jefe de Taller'),
 (2,'Secretario','Secretario general'),
 (3,'Conductor V. Livianos','Lista de Conductores de V. Livianos'),
 (4,'Conductor V.  Pesados','Lista de Conductores de V. Pesados'),
 (5,'Operario M. Pesada','Lista de Operarios de M. Pesados'),
 (6,'Técnico','Tecnicos de Mantenimiento');
...
INSERT INTO `tipo_vehiculo` (`id`,`nombre`,`tipo_conductor`,`plan_mantenimiento`,`descripcion`) VALUES 
 (1,'Automotor Liviano Gasolina Camioneta 4x2',3,1,'Automotores Livianos a Gasolina Camioneta 4x2'),
 (2,'Automotor Liviano Diesel Camioneta 4x2',3,2,'Automotores Livianos a Diesel Camioneta 4x2'),
 (3,'Automotor Pesados',4,3,'Automotores Pesados'),
 (4,'Maquinaria Rodillo',5,4,'Maquinaria - Rodillo'),
 (5,'Maquinaria Retroescabadora',5,5,'Maquinaria - Retroescabadora'),
 (6,'Maquinaria Cargadora Frontal',5,6,'Maquinaria - Cargadora Frontal'),
 (7,'Maquinaria Motoniveladora',5,7,'Maquinaria - Motoniveladora'),
 (8,'Maquinaria Bulldozer',5,8,'Maquinaria - Bulldozer'),
 (9,'Automotor Liviano Gasolina Camioneta 4x4',3,9,'Automotores Livianos a Gasolina  Camioneta 4x4'),
 (10,'Automotor Liviano Diesel Camioneta 4x4',3,10,'Automotores Livianos a Diesel Camioneta 4x4'),
 (11,'Automotor Liviano Gasolina SUV 4x2',3,11,'Automotores Livianos a Gasolina SUV 4x2'),
 (12,'Automotor Liviano Gasolina SUV 4x4',3,12,'Automotores Livianos a Gasolina SUV 4x4'),
 (13,'Automotor Liviano Diesel SUV 4x2',3,13,'Automotores Livianos a Diesel SUV 4x2'),
 (14,'Automotor Liviano Diesel SUV 4x4',3,14,'Automotores Livianos a Diesel SUV 4x4');
...
INSERT INTO `usuario` (`id`,`tipo_usuario_id`,`nombres`,`apellidos`,`identificacion`,`direccion`,`telefono`,`celular`,`email`,`usuario`,`password`,`eliminado`) VALUES 
 ...
 (2,6,'Carlos','Perez','0603718577','calle 4','','','mail1@mail.com','0603718577','e10adc3949ba59abbe56e057f20f883e',0),
 (3,3,'jose','gonza','0302424445','calle 12','234576285','0987858010','franciscobmv91@gmail.com','0302424445','e10adc3949ba59abbe56e057f20f883e',0),
 ...
 (6,3,'Víctor ',' Peralta','0302674455','carrera ingapirca y 9 de octubre','432563357','0984765523','victore55@gmail.com','0302674455','e10adc3949ba59abbe56e057f20f883e',0),
 ...
 (9,5,'Miguel ','Cárdenas','06256788876','24 de mayo y colon','235467458','0987123458','Cárdenas@gmail.com','06256788876','e10adc3949ba59abbe56e057f20f883e',0),
 ...
 (16,6,'Juan','Con','0602567802','Los Pinos','098888888','0888888888','lajane2020@hotmail.com','0602567802','e10adc3949ba59abbe56e057f20f883e',0);
...
INSERT INTO `vehiculo` (`id`,`usuario_id`,`tipo_vehiculo_id`,`estado_vehiculo_id`,`placa`,`numero`,`marca`,`modelo`,`anio`,`numero_motor`,`numero_chasis`,`medida_uso`,`eliminado`) VALUES 
 (1,3,1,1,'USA-1230','1','ppp','modelo',2015,'4JJLX9761','8LBETF3N7F0267815',750,0),
 (2,6,1,1,'UBW-193','2','CHEVROLET',NULL,2012,'6BD1-175945','8LBETFS25H40113947',2000,0),
 (3,11,1,1,'ubs-234','1','KOMATSU',NULL,2010,'26518093','75353',2345,0),
 (4,11,4,1,'usa-123','2','KOMATSU',NULL,1991,'26528413','75572',5000,0),
 (5,9,7,1,'UMA-505','26','INTERNACIONAL',NULL,2010,'362GM2UB-135281','PH48807',350658,0),
 (6,10,7,1,'UMA-0077','37','STEYR',NULL,1995,'2122437265','LZFS19L172DO12935',200356,0),
 (7,11,3,2,'sdsd','45','marca 1',NULL,2014,'sdsd','sdsd',456,1),
 (8,6,1,1,'3','2','Ejemplo',NULL,3,'3','3',430,0),
 (9,3,1,2,'llsd','191','kas','sallsa',22,'ksdk','dslls',2,0);
...
INSERT INTO `vehiculo_plan` (`id`,`vehiculo_id`,`plan_mantenimiento_id`,`numero_operacion`,`fecha_registro`,`fecha_inicio`,`eliminado`) VALUES 
 (21,8,1,'580.00','2017-06-13','2017-06-07',0),
 (22,8,14,'935.00','2017-06-12','2017-06-07',0),
 (23,1,15,'505.00','2017-06-11','2017-06-11',0);
